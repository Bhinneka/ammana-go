...
func TestAmmanaGetOrderURL(t *testing.T) {
	orderData := []byte(`{
				...
				"callback_url": "http://dummy.test/ammana-finish",
				"cancel_url": "http://dummy.test/ammana-finish",
				"items": [{
					"id" : "SKU00001",
	...
	t.Run("Test Ammana Get Payment Detail", func(t *testing.T) {
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			case "GET":
				...
				w.Write([]byte(`{
						"data": {
							"transaction_id": "7474f079-5869-4e40-9989-8439b2bc34c5",
							"status": "activated",
							"invoice_code": "TEST",
							"total": 0,
							"create_at": "2020-11-20 00:00:00",
							"paid_at": "2020-11-20 00:00:00"
						},
						"meta": {
							"hostname": "paylater-dev",
							"client_ip": "180.244.234.91"
			...
			case "PATCH":
				...
				w.Write([]byte(`{
						"data": {
							...
							"create_at": "2020-11-20 00:00:00",
							"paid_at": "2020-11-20 00:00:00",
							"settled_at": "2020-11-20 00:00:00"
						},
						"meta": {
							"hostname": "paylater-dev",
							"client_ip": "180.244.234.91"
